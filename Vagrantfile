...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "ascendbruce-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/ascendbruce"
  #   chef.validation_client_name = "ascendbruce-validator"
  #   chef.validation_key_path = ".chef/ascendbruce-validator.pem"
  # end
end
